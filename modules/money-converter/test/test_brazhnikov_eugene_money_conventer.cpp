...
TEST(test_brazhnikov_eugene_money_converter, Can_Convert_RUB_to_USD)
{
	...
	output = converter.rubdollar(input, 0);
...
TEST(test_brazhnikov_eugene_money_converter, Can_USD_to_RUB)
{
	...
	output = converter.rubdollar(input, 1);
